 ...
 * time after the {@link DocumentProcessor} submits a bulk of documents to the
 * Elasticserach instance it calls this interface's {@link #harvesterCommitted}
 * method.
 * <P>
...
public interface CommitEvent {
   ...
   * commited document identifiers. Be warned, you should have some
   * synchronization because this method is called from a different thread!
   */

...
/**
 * <code>BooleanParser</code> is a simple static class supplying a method to
 * parse booleans.
 * 
...
public final class BooleanParser {
   ...
   *           if uppercase <code>v</code> is not "TRUE", "YES", "ON", "FALSE",
   *           "NO", "OFF"
   */
  public static boolean parseBoolean(String v) {
    ...
    if ("TRUE".equals(v) || "YES".equals(v) || "ON".equals(v)) return true;
        ...
        "Boolean value must be one of: [YES,TRUE,ON]; [NO,FALSE,OFF]");
  }
